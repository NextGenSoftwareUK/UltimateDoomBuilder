...
[Setup]
AppName=ODOOM Editor
AppVersion={#UDB_GetVersionString} ({#UDB_arch})
;AppVerName=ODOOM Editor {#UDB_GetVersionString} ({#UDB_arch})
AppPublisher=NextGen World Ltd
...
DefaultDirName={userpf}\ODOOM Editor
DefaultGroupName=ODOOM Editor
AllowNoIcons=true
...
[Icons]
Name: {group}\ODOOM Editor; Filename: {app}\Builder.exe
Name: {group}\{cm:UninstallProgram,ODOOM Editor}; Filename: {uninstallexe}
Name: {autodesktop}\ODOOM Editor; Filename: {app}\Builder.exe; Tasks: desktopicon
...
[Registry]
Root: HKCU; Subkey: SOFTWARE\ODOOM Editor\; ValueType: string; ValueName: Location; ValueData: {app}; Flags: uninsdeletevalue
